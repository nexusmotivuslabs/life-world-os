...
router.get('/domains', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error listing Power law domains:', error)
...
router.get('/', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error listing power laws:', error)
...
router.get('/categories', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error listing Power law categories:', error)
...
router.get('/:id', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error getting power law:', error)
...
router.get('/by-number/:lawNumber', async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Error getting power law by number:', error)
    res.status(500).json({ error: error.message || 'Failed to get power law' })
  }
})
