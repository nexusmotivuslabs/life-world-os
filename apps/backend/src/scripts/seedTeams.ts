...
async function main() {
  ...
  const teams = [
    ...
    },
    {
      ...
      description: 'Platform reliability, security, and delivery automation',
      icon: '🛡️',
      order: 8,
      leadAgentType: 'DEVOPS_ENGINEER' as const,
      agentRoles: [
        { type: 'DEVOPS_ENGINEER' as const, role: TeamAgentRole.LEAD },
        { type: 'SOFTWARE_ARCHITECT' as const, role: TeamAgentRole.MEMBER },
        { type: 'QA_ENGINEER' as const, role: TeamAgentRole.SPECIALIST },
      ],
      guides: [
        {
    ...
    {
      domain: TeamDomain.HEALTH_NUTRITION,
      name: 'Health Nutrition Team',
      description: 'Nutrition, recovery fuel, and metabolic stability',
      icon: '🥗',
      order: 11,
      leadAgentType: 'CAPACITY_SPECIALIST' as const,
      agentRoles: [
    ...
    {
      domain: TeamDomain.HEALTH_MOVEMENT,
      name: 'Health Movement Team',
      description: 'Movement, mobility, and physical resilience',
      icon: '🏃',
      order: 12,
      leadAgentType: 'RECOVERY_COACH' as const,
      agentRoles: [
        { type: 'RECOVERY_COACH' as const, role: TeamAgentRole.LEAD },
        { type: 'CAPACITY_SPECIALIST' as const, role: TeamAgentRole.MEMBER },
        { type: 'BURNOUT_PREVENTION_SPECIALIST' as const, role: TeamAgentRole.SPECIALIST },
      ],
      guides: [],
      products: [],
    ...
    {
      domain: TeamDomain.HEALTH_SLEEP,
      name: 'Health Sleep Team',
      description: 'Sleep quality, recovery cycles, and energy restoration',
      icon: '😴',
      order: 13,
      leadAgentType: 'RECOVERY_COACH' as const,
      agentRoles: [
    ...
    {
      domain: TeamDomain.HEALTH_MENTAL,
      name: 'Health Mental Resilience Team',
      description: 'Stress regulation, mental resilience, and burnout prevention',
      icon: '🧠',
      order: 14,
      leadAgentType: 'BURNOUT_PREVENTION_SPECIALIST' as const,
      agentRoles: [
        { type: 'BURNOUT_PREVENTION_SPECIALIST' as const, role: TeamAgentRole.LEAD },
        { type: 'CAPACITY_SPECIALIST' as const, role: TeamAgentRole.MEMBER },
        { type: 'RECOVERY_COACH' as const, role: TeamAgentRole.SPECIALIST },
      ],
      guides: [],
      products: [],
    },
    {
      domain: TeamDomain.ENERGY_MANAGEMENT,
      name: 'Energy Management Team',
      description: 'Energy allocation, conservation, and optimization',
      icon: '⚡',
      order: 20,
      leadAgentType: 'ENERGY_ANALYST' as const,
      agentRoles: [
        { type: 'ENERGY_ANALYST' as const, role: TeamAgentRole.LEAD },
        { type: 'ENERGY_COACH' as const, role: TeamAgentRole.MEMBER },
        { type: 'ENERGY_RECOVERY_COACH' as const, role: TeamAgentRole.SPECIALIST },
      ],
      guides: [],
      products: [],
    },
    {
      domain: TeamDomain.ENERGY_RECOVERY,
      name: 'Energy Recovery Team',
      description: 'Restoration, downtime design, and burnout prevention',
      icon: '🌙',
      order: 21,
      leadAgentType: 'ENERGY_RECOVERY_COACH' as const,
      agentRoles: [
        { type: 'ENERGY_RECOVERY_COACH' as const, role: TeamAgentRole.LEAD },
        { type: 'ENERGY_COACH' as const, role: TeamAgentRole.MEMBER },
        { type: 'ENERGY_ANALYST' as const, role: TeamAgentRole.SPECIALIST },
      ],
      guides: [],
      products: [],
    },
    {
      domain: TeamDomain.ENERGY_FOCUS,
      name: 'Energy Focus Team',
      description: 'Focus capacity and cognitive energy management',
      icon: '🎯',
      order: 22,
      leadAgentType: 'ENERGY_COACH' as const,
      agentRoles: [
        { type: 'ENERGY_COACH' as const, role: TeamAgentRole.LEAD },
        { type: 'ENERGY_ANALYST' as const, role: TeamAgentRole.MEMBER },
        { type: 'ENERGY_RECOVERY_COACH' as const, role: TeamAgentRole.SPECIALIST },
      ],
      guides: [],
      products: [],
    ...
    {
      domain: TeamDomain.ENERGY_RHYTHM,
      name: 'Energy Rhythm Team',
      description: 'Circadian alignment and sustainable cadence',
      icon: '⏳',
      order: 23,
      leadAgentType: 'ENERGY_ANALYST' as const,
      agentRoles: [
    ...
    {
      domain: TeamDomain.ENERGY_ENVIRONMENT,
      name: 'Energy Environment Team',
      description: 'Workspace and environment design for energy stability',
      icon: '🌿',
      order: 24,
      leadAgentType: 'ENERGY_COACH' as const,
      agentRoles: [
    ...
    {
      domain: TeamDomain.TRAVEL_PLANNING,
      name: 'Travel Planning Team',
      description: 'Itinerary planning and experience design',
      icon: '🧭',
      order: 30,
      leadAgentType: 'TRAVEL_PLANNER' as const,
      agentRoles: [
        { type: 'TRAVEL_PLANNER' as const, role: TeamAgentRole.LEAD },
        { type: 'TRAVEL_LOGISTICS_COORDINATOR' as const, role: TeamAgentRole.MEMBER },
        { type: 'TRAVEL_SAFETY_ADVISOR' as const, role: TeamAgentRole.SPECIALIST },
      ],
      guides: [],
      products: [],
    },
    {
      domain: TeamDomain.TRAVEL_LOGISTICS,
      name: 'Travel Logistics Team',
      description: 'Routing, bookings, and operational travel details',
      icon: '🧳',
      order: 31,
      leadAgentType: 'TRAVEL_LOGISTICS_COORDINATOR' as const,
      agentRoles: [
        { type: 'TRAVEL_LOGISTICS_COORDINATOR' as const, role: TeamAgentRole.LEAD },
        { type: 'TRAVEL_PLANNER' as const, role: TeamAgentRole.MEMBER },
        { type: 'TRAVEL_SAFETY_ADVISOR' as const, role: TeamAgentRole.SPECIALIST },
      ],
      guides: [],
      products: [],
    ...
    {
      domain: TeamDomain.TRAVEL_SAFETY,
      name: 'Travel Safety Team',
      description: 'Safety planning and contingency preparation',
      icon: '🛡️',
      order: 32,
      leadAgentType: 'TRAVEL_SAFETY_ADVISOR' as const,
      agentRoles: [
        { type: 'TRAVEL_SAFETY_ADVISOR' as const, role: TeamAgentRole.LEAD },
        { type: 'TRAVEL_PLANNER' as const, role: TeamAgentRole.MEMBER },
        { type: 'TRAVEL_LOGISTICS_COORDINATOR' as const, role: TeamAgentRole.SPECIALIST },
      ],
      guides: [],
      products: [],
    },
    {
      domain: TeamDomain.TRAVEL_COST,
      name: 'Travel Cost Team',
      description: 'Budget control and travel cost optimization',
      icon: '💸',
      order: 33,
      leadAgentType: 'TRAVEL_PLANNER' as const,
      agentRoles: [
    ...
    {
      domain: TeamDomain.TRAVEL_EXPERIENCE,
      name: 'Travel Experience Team',
      description: 'Local experience curation and location quality',
      icon: '📍',
      order: 34,
      leadAgentType: 'TRAVEL_PLANNER' as const,
      agentRoles: [
    ...
    {
      domain: TeamDomain.MEANING_ALIGNMENT,
      name: 'Meaning Alignment Team',
      description: 'Align values with decisions and direction',
      icon: '🧩',
      order: 40,
      leadAgentType: 'VALUES_COACH' as const,
      agentRoles: [
        { type: 'VALUES_COACH' as const, role: TeamAgentRole.LEAD },
        { type: 'PURPOSE_GUIDE' as const, role: TeamAgentRole.MEMBER },
        { type: 'REFLECTION_FACILITATOR' as const, role: TeamAgentRole.SPECIALIST },
      ],
      guides: [],
      products: [],
    },
    {
      domain: TeamDomain.MEANING_PRACTICE,
      name: 'Meaning Practice Team',
      description: 'Daily practices that reinforce meaning and stability',
      icon: '🕯️',
      order: 41,
      leadAgentType: 'PURPOSE_GUIDE' as const,
      agentRoles: [
        { type: 'PURPOSE_GUIDE' as const, role: TeamAgentRole.LEAD },
        { type: 'VALUES_COACH' as const, role: TeamAgentRole.MEMBER },
        { type: 'REFLECTION_FACILITATOR' as const, role: TeamAgentRole.SPECIALIST },
      ],
      guides: [],
      products: [],
    ...
    {
      domain: TeamDomain.MEANING_REFLECTION,
      name: 'Meaning Reflection Team',
      description: 'Structured reflection and insight integration',
      icon: '🪞',
      order: 42,
      leadAgentType: 'REFLECTION_FACILITATOR' as const,
      agentRoles: [
        { type: 'REFLECTION_FACILITATOR' as const, role: TeamAgentRole.LEAD },
        { type: 'PURPOSE_GUIDE' as const, role: TeamAgentRole.MEMBER },
        { type: 'VALUES_COACH' as const, role: TeamAgentRole.SPECIALIST },
      ],
      guides: [],
      products: [],
    },
    {
      domain: TeamDomain.MEANING_COMMUNITY,
      name: 'Meaning Community Team',
      description: 'Belonging, contribution, and shared purpose',
      icon: '🤝',
      order: 43,
      leadAgentType: 'PURPOSE_GUIDE' as const,
      agentRoles: [
    ...
    {
      domain: TeamDomain.MEANING_PURPOSE,
      name: 'Meaning Purpose Team',
      description: 'Long-term purpose, direction, and coherence',
      icon: '✨',
      order: 44,
      leadAgentType: 'PURPOSE_GUIDE' as const,
      agentRoles: [
    ...
    {
      domain: TeamDomain.SOFTWARE_ARCHITECTURE,
      name: 'Software Architecture Team',
      description: 'System design, boundaries, and scalability decisions',
      icon: '🏗️',
      order: 51,
      leadAgentType: 'SOFTWARE_ARCHITECT' as const,
      agentRoles: [
        { type: 'SOFTWARE_ARCHITECT' as const, role: TeamAgentRole.LEAD },
        { type: 'DEVOPS_ENGINEER' as const, role: TeamAgentRole.MEMBER },
        { type: 'QA_ENGINEER' as const, role: TeamAgentRole.SPECIALIST },
      ],
      guides: [],
      products: [],
    ...
    {
      domain: TeamDomain.SOFTWARE_DELIVERY,
      name: 'Software Delivery Team',
      description: 'CI/CD, release strategy, and deployment safety',
      icon: '🚀',
      order: 52,
      leadAgentType: 'DEVOPS_ENGINEER' as const,
      agentRoles: [
    ...
    {
      domain: TeamDomain.SOFTWARE_QUALITY,
      name: 'Software Quality Team',
      description: 'Testing strategy, reliability, and regression prevention',
      icon: '✅',
      order: 53,
      leadAgentType: 'QA_ENGINEER' as const,
      agentRoles: [
        { type: 'QA_ENGINEER' as const, role: TeamAgentRole.LEAD },
        { type: 'SOFTWARE_ARCHITECT' as const, role: TeamAgentRole.MEMBER },
        { type: 'DEVOPS_ENGINEER' as const, role: TeamAgentRole.SPECIALIST },
      ],
      guides: [],
      products: [],
    },
    {
      domain: TeamDomain.SOFTWARE_API_DESIGN,
      name: 'Software API Design Team',
      description: 'Interface design, versioning, and service contracts',
      icon: '🧩',
      order: 54,
      leadAgentType: 'SOFTWARE_ARCHITECT' as const,
      agentRoles: [
        { type: 'SOFTWARE_ARCHITECT' as const, role: TeamAgentRole.LEAD },
        { type: 'QA_ENGINEER' as const, role: TeamAgentRole.MEMBER },
        { type: 'DEVOPS_ENGINEER' as const, role: TeamAgentRole.SPECIALIST },
      ],
      guides: [],
      products: [],
