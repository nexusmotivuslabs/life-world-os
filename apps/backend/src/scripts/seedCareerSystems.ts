...
async function main() {
  ...
  const careerTeams = [
    ...
    {
      domain: TeamDomain.OPTIONALITY_CAPITAL,
      name: 'Optionality Capital Team',
      description: 'Builds financial and time buffers that increase decision freedom',
      icon: '💰',
      order: 4,
      leadAgentType: 'RISK_STRATEGIST' as const,
      agentRoles: [
        { type: 'RISK_STRATEGIST' as const, role: TeamAgentRole.LEAD },
        { type: 'DECISION_ANALYST' as const, role: TeamAgentRole.MEMBER },
        { type: 'SYSTEMS_THINKER' as const, role: TeamAgentRole.MEMBER },
      ],
      guides: [],
      products: [],
    ...
    {
      domain: TeamDomain.OPTIONALITY_NETWORK,
      name: 'Optionality Network Team',
      description: 'Expands relationships and access to opportunities',
      icon: '🔗',
      order: 5,
      leadAgentType: 'SYSTEMS_THINKER' as const,
      agentRoles: [
        { type: 'SYSTEMS_THINKER' as const, role: TeamAgentRole.LEAD },
        { type: 'DECISION_ANALYST' as const, role: TeamAgentRole.MEMBER },
        { type: 'RISK_STRATEGIST' as const, role: TeamAgentRole.MEMBER },
      ],
      guides: [],
    ...
    {
      domain: TeamDomain.TRUST_ALIGNMENT,
      name: 'Trust Alignment Team',
      description: 'Aligns incentives, expectations, and outcomes to preserve trust',
      icon: '🧭',
      order: 6,
      leadAgentType: 'ALIGNMENT_STRATEGIST' as const,
      agentRoles: [
        { type: 'ALIGNMENT_STRATEGIST' as const, role: TeamAgentRole.LEAD },
        { type: 'TRUST_ANALYST' as const, role: TeamAgentRole.MEMBER },
        { type: 'RELIABILITY_COACH' as const, role: TeamAgentRole.MEMBER },
      ],
      guides: [],
      products: [],
    ...
    {
      domain: TeamDomain.TRUST_COMMUNICATION,
      name: 'Trust Communication Team',
      description: 'Proactive communication and expectation management',
      icon: '💬',
      order: 7,
      leadAgentType: 'COMMUNICATION_SPECIALIST' as const,
      agentRoles: [
        { type: 'COMMUNICATION_SPECIALIST' as const, role: TeamAgentRole.LEAD },
        { type: 'TRUST_ANALYST' as const, role: TeamAgentRole.MEMBER },
        { type: 'RELIABILITY_COACH' as const, role: TeamAgentRole.MEMBER },
      ],
      guides: [],
    ...
    {
      domain: TeamDomain.TRUST_DELIVERY,
      name: 'Trust Delivery Team',
      description: 'Consistent delivery and reliability under pressure',
      icon: '✅',
      order: 8,
      leadAgentType: 'RELIABILITY_COACH' as const,
      agentRoles: [
        { type: 'RELIABILITY_COACH' as const, role: TeamAgentRole.LEAD },
        { type: 'TRUST_ANALYST' as const, role: TeamAgentRole.MEMBER },
        { type: 'ALIGNMENT_STRATEGIST' as const, role: TeamAgentRole.MEMBER },
      ],
      guides: [],
    ...
    {
      domain: TeamDomain.REPUTATION_SIGNAL,
      name: 'Reputation Signal Team',
      description: 'Builds visible proof and signal quality in the market',
      icon: '📣',
      order: 11,
      leadAgentType: 'REPUTATION_GUARDIAN' as const,
      agentRoles: [
    ...
    {
      domain: TeamDomain.REPUTATION_RECOVERY,
      name: 'Reputation Recovery Team',
      description: 'Recovers trust after failures and restores credibility',
      icon: '🧯',
      order: 12,
      leadAgentType: 'FAILURE_ANALYST' as const,
      agentRoles: [
        { type: 'FAILURE_ANALYST' as const, role: TeamAgentRole.LEAD },
        { type: 'REPUTATION_GUARDIAN' as const, role: TeamAgentRole.MEMBER },
        { type: 'COMMUNICATION_SPECIALIST' as const, role: TeamAgentRole.MEMBER },
      ],
      guides: [],
      products: [],
    ...
    {
      domain: TeamDomain.REPUTATION_VISIBILITY,
      name: 'Reputation Visibility Team',
      description: 'Maintains consistent public visibility and narrative',
      icon: '👁️',
      order: 13,
      leadAgentType: 'COMMUNICATION_SPECIALIST' as const,
      agentRoles: [
    ...
    {
      domain: TeamDomain.REPUTATION_TRUST,
      name: 'Reputation Trust Team',
      description: 'Maintains trust deposits and credibility with stakeholders',
      icon: '🤝',
      order: 14,
      leadAgentType: 'TRUST_ANALYST' as const,
      agentRoles: [
