...
export default function MasterEnergy() {
  ...
  const totalLoading = loading && !energyStatus

  return (
    <MasterSystemLayout
      title="Master Energy System"
      description={isDay ? 'The sun that powers your day' : 'The moon that guides your night'}
      mantra="Energy is the currency of action."
      icon={isDay ? Sun : Moon}
      color={isDay ? 'text-yellow-400' : 'text-blue-400'}
      bgColor={isDay ? 'bg-yellow-600/20' : 'bg-blue-600/20'}
      teams={teams}
      agents={agents}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gray-700/50 rounded-lg p-4">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="font-semibold">Sleep & Rest</h3>
                </div>
                ...
                {sleepHistory.slice(0, 10).map((sleep) => (
                  ...
                  >
                    ...
                    <div className="text-sm text-gray-400">
                      Energy Restored:{' '}
                      <span className="text-blue-400 font-semibold">+{sleep.energyRestored}</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Base energy only restores through sleep. Caffeine and food provide temporary
                    boosts but don't restore base energy.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Track caffeine, food, and supplements. These add temporary energy but don't
                    restore base energy.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Capacity modifies usable energy cap. High capacity = more energy. Low capacity =
                    less energy.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Learn from Bible Laws and 48 Laws of Power applied to energy management and
                    sleep.
                  </p>
                </div>
              </div>
